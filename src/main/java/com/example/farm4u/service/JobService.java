...
public class JobService {
    ...
    public JobDto autoWriteAndCreateJob(Long userId, MultipartFile audioFile) throws IOException {
        ...
        AutoJobResponse autoGenerated = aiClient.autoWriteJob(audioFile);

        // 3. 농가 정보 반영 (주소/면적 자동 세팅)
        jobdto.setUserId(userId);
        jobdto.setAddress(farmer.getAddress());
        jobdto.setTitle(autoGenerated.getTitle());
        jobdto.setStartDate(autoGenerated.getStartDate());
        jobdto.setEndDate(autoGenerated.getEndDate());
        jobdto.setStartTime(autoGenerated.getStartTime());
        jobdto.setEndTime(autoGenerated.getEndTime());
        jobdto.setAreaSize(autoGenerated.getAreaSize());
        jobdto.setMeal(autoGenerated.getMeal());
        jobdto.setSnack(autoGenerated.getSnack());
        jobdto.setTransportAllowance(autoGenerated.getTransportAllowance());
        jobdto.setDescription(autoGenerated.getDescription());
        jobdto.setSalaryMale(autoGenerated.getSalaryMale());
        jobdto.setSalaryFemale(autoGenerated.getSalaryFemale());
        jobdto.setRecruitCountMale(autoGenerated.getRecruitCountMale());
        jobdto.setRecruitCountFemale(autoGenerated.getRecruitCountFemale());
        jobdto.setExperienceRequired(autoGenerated.getExperienceRequired());
