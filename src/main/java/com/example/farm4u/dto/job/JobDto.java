...
public class JobDto {
    ...
    public JobDto(Job job) {
        ...
        this.startDate = job.getStartDate()!=null? job.getStartDate().toString() : null;
        this.endDate = job.getEndDate()!=null? job.getEndDate().toString() : null;
        this.startTime = job.getStartTime()!=null? job.getStartTime().toString() : null;
        this.endTime = job.getEndTime()!=null? job.getEndTime().toString() : null;
